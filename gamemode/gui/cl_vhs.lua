...
timer.Create("EvilPlayStatic", 0.1, 0, function()
	...
	local shouldPlay = Round:IsPlaying() and IsValid(lp) and IsValid(Game:GetBoss()) and not lp:IsBoss() and not lp:IsProxy() and lp:GetPos():Distance(Game:GetBoss():GetPos()) < 600
