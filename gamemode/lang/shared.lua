...
Lang.Translations = {
    en = {
        ...
        ["#Gman_Taunt_TimeDrFreeman"] = "Time?", 
        ["#Gman_Taunt_GetOff"] = "This is where\nI get off", 
        ["#Gman_Taunt_GreatDeal"] = "You've done a great\ndeal in a\nsmall timespan", 
        ["#Gman_Taunt_Arrived"] = "It seems as if\nyou only just\n arrived", 
        ["#Gman_Taunt_TimeAgain"] = "Is it really\nthat time again", 
        ["#Gman_Taunt_RightMan"] = "The right man\nin the wrong\nplace can make\nall the difference", 
        ["#Gman_Taunt_WakeUp"] = "Wake up",
